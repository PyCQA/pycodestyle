...
**(*)** In **(*)** In the default configuration, the checks **E121**, **E123**, **E126**, **E133**,
...
>>>>>>>-master
ault con**(*)** In the default configuration, the checks **E121**, **E123**, **E126**,
...
>>>>>>>+gh-502
be disabled at the line level using the ``# noqa``
